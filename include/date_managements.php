...
$hari_ini = $arr_nama_hari[date('w')] . ', ' . date('d') . ' ' . $arr_nama_bulan[intval(date('m')) - 1] . ' ' . date('Y');

$now = date('Y-m-d H:i:s');
$today = date('Y-m-d');

$hari_ini_show = $arr_nama_hari[date('w', strtotime('today'))] . ', ' . date('d M Y H:i', strtotime('now'));
