<?php if(!isset($id_do)){ ?>
  ...
  <p>Packing adalah proses ketiga setelah adanya Delivery Order. Sifatnya opsional jika barang tidak perlu proses packing. Terdiri dari:</p>
  <ul>
    <li>Pelabelan Barang</li>
    <li>Pemilihan Wahana Packing yang tepat</li>
    <li>Perhitungan kembali hasil packing agar sesuai dengan Delivery Order</li>
  </ul>

  <div class='alert alert-info'>
    Proses Packing harus diawali dengan Picking dan Delivery Order. 
    <hr>
...
<div class="wadah gradasi-hijau">
  <h2 class=tengah>Packing List</h2>
  <div class="wadah">
    <div class="row">
      <div class="col-6">
        <div class="row">
  ...
  <hr>
  <button class='btn btn-primary'>Cetak Packing List</button>
</div>
<?php } ?>