...
if($terverifikasi && $sudah_upload){
  $btn_cetak_bbm = "<a href='?po&p=terima_barang&kode_po=$kode_po&id_bbm=$id_bbm&view_mode=cetak' class='btn btn-success w-100' target=_blank'>Cetak Bukti Barang Masuk</a>";
}else{
